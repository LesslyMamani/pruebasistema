                                ...
                                <div class="nftmax-header__right">
                                    <div class="nftmax-header__alarm"><svg xmlns="http://www.w3.org/2000/svg"
                                            ...
                                            <path
                                                ...
                                                fill="#374557"></path>
                                        </svg><span class="nftmax-header__count">3</span>
                                        <!-- NFTMax Alarm Hover -->
                                            ...
                                            <ul class="nftmax-balance_list">
                                                ...
                                                <li>
                                                    <div class="nftmax-balance-info">
                                                        ...
                                                        <div class="nftmax-alarm__content">
                                                            <h4 class="nftmax-balance-name"><strong
                                                                    class="nftmax-balance__second">Thank you
                                                                    !</strong> you made your frast sell <strong
                                                                    class="nftmax-balance__second">232.98
                                                                    ETH</strong></h4>
                                                            <p class="nftmax-alarm__text">2 days ago</p>
                                                        </div>
                                                    </div>
                                                ...
                                                <li>
                                                    <div class="nftmax-balance-info">
                                                        <div class="nftmax-balance__img nftmax-alarm__img-four">
                                                            <img src="img/notify-4.png" alt="#">
                                                        </div>
                                                        <div class="nftmax-alarm__content">
                                                            <h4 class="nftmax-balance-name"><strong
                                                                    class="nftmax-balance__second">Broklan
                                                                    Simons</strong>Start Following you</h4>
                                                            <p class="nftmax-alarm__text">2 days ago</p>
                                                        </div>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="nftmax-balance-info">
                                                        ...
                                                        <div class="nftmax-alarm__content">
                                                            <h4 class="nftmax-balance-name">you ranked up and
                                                                now you are a <strong
                                                                    class="nftmax-balance__second">Auther
                                                                    Master</strong></h4>
                                    ...
                                    <div class="nftmax-header__author">
                                        <div class="nftmax-header__author-img"><img src="img/profile-pic.png"
                                                alt="#"></div>
                                            ...
                                            <ul class="nftmax-balance_list">
                                                <li>
                                                    <div class="nftmax-balance-info">
                                                        ...
                                                        <h4 class="nftmax-balance-name"><a href="profile.html">My
                                                                Profile</a></h4>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="nftmax-balance-info">
                                                        ...
                                                        <h4 class="nftmax-balance-name"><a
                                                                href="chat-messages.html">Message</a><span
                                                ...
                                                <li>
                                                    <div class="nftmax-balance-info">
                                                        ...
                                                        <h4 class="nftmax-balance-name"><a href="#"
                                                                data-bs-target="#logout_modal" data-bs-toggle="modal"
                                                                data-bs-target="#logout_modal">Log
                                                                Out</a></h4>
                                                    </div>
                                                </li>
                                            </ul>
